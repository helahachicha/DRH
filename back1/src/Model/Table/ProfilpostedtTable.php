 ...
 * Profilpostedt Model
 *
 * @method \App\Model\Entity\Profilpostedt newEmptyEntity()
 * @method \App\Model\Entity\Profilpostedt newEntity(array $data, array $options = [])
 * @method \App\Model\Entity\Profilpostedt[] newEntities(array $data, array $options = [])
 * @method \App\Model\Entity\Profilpostedt get($primaryKey, $options = [])
 * @method \App\Model\Entity\Profilpostedt findOrCreate($search, ?callable $callback = null, $options = [])
 * @method \App\Model\Entity\Profilpostedt patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \App\Model\Entity\Profilpostedt[] patchEntities(iterable $entities, array $data, array $options = [])
 * @method \App\Model\Entity\Profilpostedt|false save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\Profilpostedt saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\Profilpostedt[]|\Cake\Datasource\ResultSetInterface|false saveMany(iterable $entities, $options = [])
 * @method \App\Model\Entity\Profilpostedt[]|\Cake\Datasource\ResultSetInterface saveManyOrFail(iterable $entities, $options = [])
 * @method \App\Model\Entity\Profilpostedt[]|\Cake\Datasource\ResultSetInterface|false deleteMany(iterable $entities, $options = [])
 * @method \App\Model\Entity\Profilpostedt[]|\Cake\Datasource\ResultSetInterface deleteManyOrFail(iterable $entities, $options = [])
 *
 * @mixin \Cake\ORM\Behavior\TimestampBehavior
 */
class ProfilpostedtTable extends Table
{
    /**
     * Initialize method
     *
