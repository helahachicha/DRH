...
export class ListingdevtComponent implements OnInit {
  ...
  getallDevT() {
    this.dataService.get('Idpropostedt/getAllIdpropostedt.json').subscribe(res => {
  ...
  getallProfilP() {
    this.dataService.get('Profilpostedt/getAllProfilpostedt.json').subscribe(res => {
