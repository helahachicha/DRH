...
public Infoprofessionnelles
  public moyenForm = new FormGroup({
    ...
    delivreecin: new FormControl('', [Validators.required]),
    ...
    datemariedivorce: new FormControl('', [Validators.required]),
    activitesportive: new FormControl('', [Validators.required]),
    lequelsport: new FormControl('', [Validators.required]),
    activitecreative: new FormControl('', [Validators.required]),
    lequelcreative: new FormControl('', [Validators.required]),
    ...
    salledesport: new FormControl('', [Validators.required]),
    joursdispo: new FormControl('', [Validators.required]),
    ...
    lequelbenevolat: new FormControl('', [Validators.required]),
    lieuact: new FormControl('', [Validators.required]),
    exercezactivite: new FormControl('', [Validators.required]),
    pointforce: new FormControl('', [Validators.required]),
    pointameliore: new FormControl('', [Validators.required]),
    nomprenomep: new FormControl('', [Validators.required]),
    datenep: new FormControl('', [Validators.required]),
    ...
    datene: new FormControl('', [Validators.required]),
    ...
    anneex: new FormControl('', [Validators.required]),
